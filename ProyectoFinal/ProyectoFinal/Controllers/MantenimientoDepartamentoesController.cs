...
{
    public class MantenimientoDepartamentoesController : Controller
    {
        private sistemaNominaEntities db = new sistemaNominaEntities();

        // GET: MantenimientoDepartamentoes
        public ActionResult Index()
        {
            return View(db.MantenimientoDepartamentos.ToList());
        }

        // GET: MantenimientoDepartamentoes/Details/5
        ...
        // GET: MantenimientoDepartamentoes/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: MantenimientoDepartamentoes/Create
        ...
        // GET: MantenimientoDepartamentoes/Edit/5
        ...
        // POST: MantenimientoDepartamentoes/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: MantenimientoDepartamentoes/Delete/5
        ...
        // POST: MantenimientoDepartamentoes/Delete/5
