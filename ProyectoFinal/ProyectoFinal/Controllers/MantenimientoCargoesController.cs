...
{
    public class MantenimientoCargoesController : Controller
    {
        private sistemaNominaEntities db = new sistemaNominaEntities();

        // GET: MantenimientoCargoes
        public ActionResult Index()
        {
            return View(db.MantenimientoCargos.ToList());
        }

        // GET: MantenimientoCargoes/Details/5
        ...
        // GET: MantenimientoCargoes/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: MantenimientoCargoes/Create
        ...
        // GET: MantenimientoCargoes/Edit/5
        ...
        // POST: MantenimientoCargoes/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: MantenimientoCargoes/Delete/5
        ...
        // POST: MantenimientoCargoes/Delete/5
